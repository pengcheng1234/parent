...
import com.jd.m.cms.bjshare.domain.vo.ActivityDataCountVo;
 ...
 */
@Service
public class DataStatisticalJsfServiceImplTemp {

    private static final Logger log = Logger.getLogger(DataStatisticalJsfServiceImplTemp.class);
