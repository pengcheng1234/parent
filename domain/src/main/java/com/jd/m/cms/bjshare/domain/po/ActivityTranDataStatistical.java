...
import com.jd.m.cms.bjshare.common.utils.BeanUtil;

import java.util.ArrayList;
import java.util.Date;
import java.util.List;

public class ActivityTranDataStatistical {
    ...
    public static List<ActivityTranDataStatistical> tranDataStatistical(List<ActivityDataStatistical> activityDataStatisticalList) {
        List<ActivityTranDataStatistical> activityTranDataStatisticals = new ArrayList<ActivityTranDataStatistical>();
        if(activityDataStatisticalList == null || activityDataStatisticalList.size() == 0) {
            return  new ArrayList<ActivityTranDataStatistical>();
        }
        for(ActivityDataStatistical entity : activityDataStatisticalList) {
            ActivityTranDataStatistical activityTranDataStatistical = new ActivityTranDataStatistical();
            BeanUtil.copyProperties(entity,activityTranDataStatistical);
            if(entity.getBizType() != null) {

                //1、商详；2、店铺；3、通天塔
                switch(entity.getBizType()) {
                    case 1 : activityTranDataStatistical.setBizType("商详");break;
                    case 2 : activityTranDataStatistical.setBizType("店铺");break;
                    case 3 : activityTranDataStatistical.setBizType("通天塔");break;
                    default:activityTranDataStatistical.setBizType("");
                }
            }
            activityTranDataStatisticals.add(activityTranDataStatistical);
        }
        return activityTranDataStatisticals;
    }
